        ...
        <div className='relative h-lvh flex justify-center items-center overflow-hidden' id='hero'>
            ...
            <div className='max-w-7xl w-full h-lvh px-6 md:px-8 relative z-20 py-32 md:py-40'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    {/* Botones CTA */}
                    <div className='flex flex-col md:flex-row gap-4 md:gap-6 animate-fade-up animate-delay-500 w-full md:w-auto items-center justify-center'>
                    ...
                    <div className='hidden sm:grid grid-cols-3 gap-4 md:gap-8 mt-8 w-full max-w-4xl animate-fade-up animate-delay-700'>
                        {[
                            {
                                svg: (
